...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('Welcome back to DocSearch!', 'success');
      navigate('/');
    } catch (err) {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-slate-50 dark:bg-[#070b14] px-6">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl glass-card relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Sign in to search and chat with your files</p>
        </div>
